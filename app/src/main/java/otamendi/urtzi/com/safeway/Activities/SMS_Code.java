...
public class SMS_Code extends AppCompatActivity {
    ...
    public void bindUI(){
        toolbar = findViewById(R.id.smsCode_toolbar);
       codeView= findViewById(R.id.smsInput);
        SMSverifyButton= findViewById(R.id.SMSverifyButton);
    }
    ...
    public SimpleCallback<String> errorToast= new SimpleCallback<String>() {
        ...
        public void callback(String data) {
            Toasty.error(SMS_Code.this, getResources().getString(R.string.error), Toast.LENGTH_LONG,true).show();
